...
export function HeroSection() {
  return (
    <div className="items-center w-full z-0 min-h-screen relative justify-items-center gap-16">
      ...
      <div className="min-h-screen w-full text-neutral-50 gap-7 flex flex-col justify-between px-20 pb-20 pt-32 z-10">
        <div className="border-l-4 py-3 pl-6 border-[#1059BD] text-neutral-50 font-semibold text-lg md:text-2xl">
          Firm
        </div>
        <h1 className="md:text-5xl text-3xl font-bold text-end">
